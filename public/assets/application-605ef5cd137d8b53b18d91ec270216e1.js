...
(function() {
  $(function() {
    $('.container').on('mouseenter', 'a[data-toggle=tooltip]', function() {
      return $(this).popover({
        selector: '',
        placement: 'left',
        trigger: 'hover',
    ...
    }).on('mouseleave', 'a[data-toggle=tooltip]', function() {
      return $(this).popover('hide');
    }).on('click', 'a[data-toggle=tooltip]', function(e) {
      e.preventDefault();
      return e.stopPropagation();
    });
    return $('.contracts').on('click', '.contract .contract-header', function(e) {
      return $(this).closest('.contract').toggleClass('expanded').prev().toggleClass('before-expand').end().find('.flights').slideToggle(100);
    });
  });
...
(function() {
  $(function() {
    $('.mission_packs').on('click', '.mission-pack .mission-pack-header', function(e) {
      return $(this).closest('.mission-pack').toggleClass('expanded').prev().toggleClass('before-expand').end().find('.missions').slideToggle(100);
    });
    $('.importable_packs').on('click', '.mission-pack .mission-pack-header', function(e) {
      return $(this).closest('.mission-pack').toggleClass('expanded').prev().toggleClass('before-expand').end().find('.missions').slideToggle(100);
    });
    return $('.container').on('click', 'a[data-load-remote]', function(e) {
      var target, url;
